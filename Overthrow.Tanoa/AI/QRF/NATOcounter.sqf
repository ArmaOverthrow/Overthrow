...
_comp = AIT_NATO_Vehicle_AirTransport call ISSE_Cfg_Vehicle_GetName;
_an = "A";
if((_ao select [0,1]) in ["A","E","I","O","a","e","i","o"]) then {_an = "An"};
[3,_ao,"Known Intel",format["Intelligence reports that NATO will insert troops at this location. %1 %2 is known to be departing %3 with %4 personnel. CAS Support also incoming, composition unknown.",_an,_comp,AIT_NATO_HQ,count _soldiers]] remoteExec ["intelEvent",0,false];
