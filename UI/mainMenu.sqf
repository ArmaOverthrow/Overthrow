...
_ctrl ctrlSetStructuredText parseText format["
	...
	<t align='left' size='0.7'>Weather: %7</t><br/>
	<t align='left' size='0.7'>Forecast: %8</t><br/>
",name player,_town,_plusmin,_standing,_pm,_rep,_weather,server getVariable "forecast"];
