...
_ctrl ctrlSetStructuredText parseText format["
	...
	%10
",name player,_town,_plusmin,_standing,_pm,_rep,_weather,server getVariable "forecast",player getVariable ["influence",0],_extra,["FUEL","Tanoa",100] call OT_fnc_getPrice];
