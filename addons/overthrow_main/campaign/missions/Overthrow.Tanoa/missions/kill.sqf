...
private _numtokill = round(random 8)+1;
private _title = "Kill NATO";
//This next number multiplies the reward
private _difficulty = 0.8 + (10/_numtokill);

//Build a mission description
_description = format["Nothing spurs on the resistance more than just killing some blues. Kill any %1 NATO anywhere without being shot.",_numtokill];
