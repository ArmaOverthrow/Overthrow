...
/*
	...
	Description:
		Function for finding the closest WorldPos position (Left, Ride, Front, Rear) to an entity. && then finding a suitable position near that entity.
...
//First we need to get all the positions around the object, && mark each as front,rear,left,right.
