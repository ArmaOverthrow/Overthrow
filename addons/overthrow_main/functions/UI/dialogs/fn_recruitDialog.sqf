...
if ((typeof _building isEqualTo OT_barracks) && isNil "_base") exitWith {};
if ((typeof _building isEqualTo OT_barracks) && !_good) exitWith {"This barracks is under NATO control" call OT_fnc_notifyMinor};
