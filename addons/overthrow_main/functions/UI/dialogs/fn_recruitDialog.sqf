...
if ((typeof _building isEqualTo OT_barracks) and isNil "_base") exitWith {};
if ((typeof _building isEqualTo OT_barracks) and !_good) exitWith {"This barracks is under NATO control" call OT_fnc_notifyMinor};
