...
if(({side _x isEqualTo west or side _x isEqualTo east} count (_pos nearEntities 50)) > 0) exitWith {"You cannot recruit with enemies nearby" call OT_fnc_notifyMinor};
