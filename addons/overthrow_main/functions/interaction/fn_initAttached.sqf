...
_ls = [ (_this select 0),"","","","speed _target <= 1 AND speed _target >= -1 AND _target distance _this < 5  AND vehicle _this isEqualTo _this AND ( typeNAME (_target getVariable 'OT_Attached') != 'BOOL' OR typeNAME (_target getVariable 'OT_Local') != 'BOOL')","true",{},{},{},{},[],13,nil,false,false] call BIS_fnc_holdActionAdd;
