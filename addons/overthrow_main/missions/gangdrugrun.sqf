...
_reward = floor((_startpos distance2D _destination) * 0.02 * _numitems);

_markerPos = _destination;
_params = [_destination,_gangid,_numitems,_reward];

//Build a mission description and title
private _description = format["We need someone to deliver %1 x Ganja to a customer in %2. You have 6 hours.</t><br/><br/><t size='0.9' align='center'>Reward: +5 (%3), $%4",_numitems,_destinationName,_gangname,_reward];
...
[
    ...
    _markerPos,
    {
        ...
        _civ forceAddUniform (OT_clothes_civilian call BIS_fnc_selectRandom);
