...
private _destinationName = _nearestOb select 1;
private _known = 0;
{
...
private _description = format["The resistance could use some information on the military presence at %1. Go and check it out, but keep your distance and try not to alert them. A pair of binoculars would be useful, we will notify as you spot personnel.",_destinationName];
private _title = format["%1 Recon",_destinationName];
...
[
    ...
    },
    {
        ...
        if(_active) exitWith {
            ...
            private _need = round(_count * 0.5);
