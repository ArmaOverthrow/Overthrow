name = "Overthrow 0.7.5.2"; //This name will be displayed only in game , specifically the expansion menu
...
description = "Overthrow - Version 0.7.5.2"; // Addon Description
